...
import {
  ...
  Zap,
    ...
    function MO({
        ...
        let [showMealSheet, setShowMealSheet] = (0, React.useState)(!1), [mealName, setMealName] = (0, React.useState)(""), [mealWater, setMealWater] = (0, React.useState)(""), [mealProtein, setMealProtein] = (0, React.useState)(""), [mealCalories, setMealCalories] = (0, React.useState)("");
        let u = e.logs[t] || [],
        ...
        return React.default.createElement("div", null, React.default.createElement("div", {
            ...
            className: "wt-action-btn meal",
            onClick: () => setShowMealSheet(!0)
        }, React.default.createElement(UtensilsCrossed, {
            size: 20,
            color: "#fff"
        }), "Log a Meal")), showMealSheet && React.default.createElement("div", {
            className: "wt-backdrop",
            onClick: () => setShowMealSheet(!1)
        }, React.default.createElement("div", {
            className: "wt-sheet",
            onClick: e => e.stopPropagation()
        }, React.default.createElement("div", {
            className: "wt-sheet-header"
        }, React.default.createElement("h3", null, "Log a Meal"), React.default.createElement("button", {
            className: "wt-icon-btn",
            onClick: () => setShowMealSheet(!1),
            "aria-label": "Close"
        }, React.default.createElement(XIcon, {
            ...
            className: "wt-field"
        }, "Meal name (optional)", React.default.createElement("input", {
            type: "text",
            placeholder: "e.g. Protein Shake",
            value: mealName,
            ...
            placeholder: "0",
            value: mealWater,
            onChange: e => setMealWater(e.target.value)
        })), React.default.createElement("label", {
            className: "wt-field"
        }, "Protein (g)", React.default.createElement("input", {
            type: "number",
            ...
            className: "wt-field"
        }, "Calories (cal)", React.default.createElement("input", {
            type: "number",
            inputMode: "decimal",
            placeholder: "0",
            value: mealCalories,
            ...
            className: "wt-btn-primary",
            onClick: () => {
                let waterVal = Number(mealWater) || 0,
                    proteinVal = Number(mealProtein) || 0,
                    caloriesVal = Number(mealCalories) || 0;
                (waterVal > 0 || proteinVal > 0 || caloriesVal > 0) && onLogMeal(waterVal, proteinVal, caloriesVal, mealName.trim()), setShowMealSheet(!1), setMealName(""), setMealWater(""), setMealProtein(""), setMealCalories("")
            }
        }, "Log This Meal"))))
    }
    ...
    function WO({
        ...
        return React.default.createElement("div", {
        ...
        }, X && React.default.createElement(TrackerRow, {
            icon: Droplet,
            iconBg: "#E3F2FD",
            iconColor: "#1565C0",
            label: "Water",
        ...
        }), Y && React.default.createElement(TrackerRow, {
            icon: Battery,
            iconBg: "#F3E5F5",
            iconColor: "#6A1B9A",
            label: "Protein",
        ...
        }), K && React.default.createElement(TrackerRow, {
            icon: Flame,
            iconBg: "#FFF3E0",
            iconColor: "#E65100",
            label: "Calories",
        ...
        }), Q && React.default.createElement(TrackerRow, {
            icon: Bed,
            iconBg: "#E8EAF6",
            iconColor: "#283593",
            label: "Sleep",
        ...
        }), Z && React.default.createElement(TrackerRow, {
            icon: Weight,
            iconBg: "#E0F2F1",
            iconColor: "#00695C",
            label: "Weight",
        ...
        }), te && React.default.createElement(TrackerRow, {
            icon: Dumbbell,
            iconBg: "#FCE4EC",
            iconColor: "#880E4F",
            label: "Exercise",
        ...
        }), J && React.default.createElement(TrackerRow, {
            icon: Pill,
            iconBg: "#FFF8E1",
            iconColor: "#F57F17",
            label: "RX & Vitamins",
        ...
        }), ee && React.default.createElement(TrackerRow, {
            icon: Syringe,
            iconBg: "#E8F5E9",
            iconColor: "#1B5E20",
            label: "Treatments",
            ...
            size: 20
        }), " Add Partner"), React.default.createElement(RegimenSummaryCard, {
            icon: Users,
            iconBg: "#E0F2F1",
            iconColor: "#00695C",
            label: "Self-Managed",
        ...
        }), "presets" === expandedList && React.default.createElement(PlanSheet, {
            title: "Quick Presets",
            onClose: () => setExpandedList(null)
        }, 0 === e.settings.presets.length && React.default.createElement("p", {
            className: "wt-empty-note",
            style: {
                marginBottom: 10
            }
    ...
    function HO({
        ...
        }, [e.settings.testerName]), React.default.createElement("div", null, React.default.createElement("label", {
            className: "wt-field",
            style: {
                marginBottom: 10
            }
