    ...
    function MO({
        ...
        if (compact) {
            let compactTile = (label, colorVar, onClick, ring) => React.default.createElement("div", {
                ...
                enabledCount = [x, E, k, S, O, j, C, P, supShow].filter(Boolean).length,
