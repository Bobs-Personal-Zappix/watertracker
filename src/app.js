...
import {
  ...
  Zap,
    ...
    function CO({
        ...
        }, "Add partners on My Plan's Self-Managed Prescriptions & Supplements section to link this item to one."), isRx && "" === selectedPartnerId && React.default.createElement("label", {
            className: "wt-field"
    ...
    function jO({
        ...
        }, "Add partners on My Plan's Self-Managed Prescriptions & Supplements section to link this item to one."), "" === selectedPartnerId && React.default.createElement("label", {
            className: "wt-field"
    ...
    function WO({
        ...
        return React.default.createElement("div", {
            ...
            className: "wt-plan-section-label"
        }, "My Treatments"), e.settings.partners.map(partner => {
    ...
    (0, ReactDOM.createRoot)(document.getElementById("root")).render(React.default.createElement(function() {
        ...
        }, "today" === r ? "My Day's Summary for:" : "rx" === r ? "SCRIPTS FOR:" : "reports" === r ? "CURRENT STATS FOR:" : "setup" === r ? "My Plan for:" : "settings" === r ? "Settings" : "profile" === r ? "Profile" : "Tracking for:"), "settings" !== r && "profile" !== r && React.default.createElement(React.default.Fragment, null, " ", function(e) {
            return e.toLocaleDateString(void 0, {
                weekday: "long",
                month: "short",
                day: "numeric"
