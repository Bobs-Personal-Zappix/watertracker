...
import {
  ...
  Zap,
    ...
    function TrackerRow({
        ...
        }, label)), React.default.createElement("button", {
            className: "wt-switch " + (on ? "on" : ""),
            onClick: e => {
                e.stopPropagation(), onToggle()
            },
            "aria-label": `Toggle ${label} on Log page`
        }, React.default.createElement("span", null))), null !== goalDisplay && React.default.createElement("div", {
    ...
    function WO({
        ...
        let [S, O] = (0, React.useState)(String(e.settings.goalOz || "")), [P, C] = (0, React.useState)(String(e.settings.goalProtein || "")), [j, N] = (0, React.useState)(String(e.settings.goalCalories || "")), [T, A] = (0, React.useState)(String(e.settings.goalSleepHours || "")), [M, _] = (0, React.useState)(!1), [D, z] = (0, React.useState)(null), [I, L] = (0, React.useState)(!1), [R, B] = (0, React.useState)(null), [$, F] = (0, React.useState)(!1), [U, W] = (0, React.useState)(null), [showHiddenTrackers, setShowHiddenTrackers] = (0, React.useState)(!1), [expandedList, setExpandedList] = (0, React.useState)(null), [openTracker, setOpenTracker] = (0, React.useState)(null), [showAddPartner, setShowAddPartner] = (0, React.useState)(!1);
        (0, React.useEffect)(() => {
