    ...
    function ProfilePage({
        ...
        return React.default.createElement("div", {
            ...
            onChange: e => {
                ...
                if (!t) return;
                if (t.size > 2097152) return void d("That image is too large. Please choose one under 2MB.");
                let n = new FileReader;
                n.onload = () => {
                    c(n.result), d("")
                }, n.readAsDataURL(t)
