...
import {
  ...
  Zap,
    ...
    function HO({
        ...
        }, "today" === r ? "Tracking Plan & Summary for:" : "reports" === r ? "CURRENT STATS FOR:" : "setup" === r ? "My Plan for:" : "settings" === r ? "Settings" : "Tracking for:"), "settings" !== r && React.default.createElement(React.default.Fragment, null, " ", function(e) {
            return e.toLocaleDateString(void 0, {
                weekday: "long",
                month: "short",
                day: "numeric"
