...
import {
  ...
  Zap,
    ...
    function xO({
        ...
        }, "Defaults to now — change it if you're catching up on something from earlier today."), !t && React.default.createElement("button", {
            type: "button",
            style: {
                display: "block",
                width: "100%",
    ...
    function MO({
        ...
        return React.default.createElement("div", null, React.default.createElement("div", {
        ...
        }, p <= 0 ? "Set a goal" : y > 0 ? `${y}oz to go` : s - p + "oz over 🎉"), React.default.createElement("div", {
            ...
            className: "wt-tile-togo"
        }, m <= 0 ? "Set a goal" : v > 0 ? `${v}g to go` : c - m + "g over 🎉"), React.default.createElement("div", {
            className: "wt-tile-logged"
            ...
            className: "wt-tile-togo"
        }, h <= 0 ? "Set a goal" : b > 0 ? `${b}cal left` : f - h + "cal over"), React.default.createElement("div", {
            className: "wt-tile-logged"
        ...
        }, "😴 Sleeping…") : g <= 0 ? "Set a goal" : w > 0 ? `${w}hrs to go` : `${Math.abs(w)}hrs over 🎉`), React.default.createElement("div", {
            className: "wt-tile-logged"
            ...
            size: 20,
            color: "#fff"
        }), "Use Your Presets or Log a Meal")))
    }
    ...
    function HO({
        ...
        }, "HydroPro Tracker")), React.default.createElement("div", {
            className: "wt-topbanner-ai",
            "aria-hidden": "true"
        }, React.default.createElement(Sparkles, {
            size: 18,
            color: "var(--accent)"
        }))), React.default.createElement("svg", {
        ...
        }, "today" === r ? "Day Planner:" : "reports" === r ? "TO DATE STATS:" : "setup" === r ? "My Plan for:" : "settings" === r ? "Settings" : "Day Tracker:"), "settings" !== r && React.default.createElement(React.default.Fragment, null, " ", function(e) {
            return e.toLocaleDateString(void 0, {
                weekday: "long",
                month: "short",
                day: "numeric"
